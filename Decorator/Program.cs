...
namespace Decorator
{
    class Program
    {
        ...
        {
            var personalCar = new PersonalCar { Make="VolksWagen",Model="Polo", HirePrice=1000};

            SpecialOffer specialOffer = new SpecialOffer(personalCar);
            specialOffer.discountRate = (decimal)0.1;
   ...
   abstract class CarDecoratorBase : CarBase
    ...
    class SpecialOffer : CarDecoratorBase
    {
        ...
        public override decimal HirePrice {
            get
            {
                return _carBase.HirePrice-_carBase.HirePrice*discountRate;
            }
            set
            {
